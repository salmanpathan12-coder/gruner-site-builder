...
const highlights = [
  {
    ...
    title: "Our Mission",
    description:
      "To accelerate India's transition to clean energy by converting agricultural waste into sustainable Bio-CNG fuel.",
  },
  {
    icon: Factory,
      ...
      <div className="container-wide relative z-10" ref={ref}>
        ...
        >
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto text-base md:text-lg font-body leading-relaxed">
            Gruner Renewable Energy is a Noida-based clean energy company pioneering India's Bio-CNG revolution. We
            design, build, and operate compressed biogas plants that transform agricultural residue into sustainable
            transportation fuel, reducing fossil fuel dependency while empowering rural communities.
          </p>
        </motion.div>
          ...
          >
            <div className="p-6 rounded-2xl bg-gradient-to-br from-primary/5 to-accent/5 border border-border/50">
              ...
              <p className="text-muted-foreground font-body leading-relaxed mb-4">
                Founded with a vision to address India's dual challenge of agricultural waste management and energy
                security, Gruner has rapidly grown to become a leading Bio-CNG infrastructure company. We've secured
                over ₹1,500 Crore in project orders and $60M in funding to expand our CBG footprint.
              </p>
              <p className="text-muted-foreground font-body leading-relaxed">
                Our proprietary technology processes diverse feedstocks including Napier Grass, agricultural residue,
                and organic waste to produce high-quality compressed biogas that meets automotive fuel standards.
              </p>
            </div>
        ...
        >
          {[
            ...
            <div key={stat.label} className="text-center">
              ...
              <div className="text-xs md:text-sm text-white/60 font-body">{stat.label}</div>
            </div>
          ))}
        </motion.div>
      </div>
