...
const AboutHero = () => {
  ...
  return (
    <section ref={containerRef} className="relative min-h-[70vh] flex items-center bg-white overflow-hidden">
      {/* HEADER SAFE ZONE */}
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <motion.div style={{ y }} className="relative z-10">
            ...
            >
              <a
                href="/contact"
                className="group inline-flex items-center gap-2 px-6 py-3 bg-green-700 text-white font-medium shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 text-sm"
              >
                Start Your Project
              ...
              <a
                href="/solutions"
                className="inline-flex items-center gap-2 px-6 py-3 bg-white border border-black/15 text-black font-medium transition-all duration-300 text-sm hover:bg-black/5"
              >
                Explore Solutions
              </a>
            </motion.div>
            ...
            >
              {[
                ...
                <div key={stat.label} className="relative">
                  ...
                  <motion.div
                    className="absolute -bottom-1 left-0 h-0.5 bg-gradient-to-r from-green-700 to-green-500"
                    initial={{ width: 0 }}
                    animate={{ width: 28 }}
