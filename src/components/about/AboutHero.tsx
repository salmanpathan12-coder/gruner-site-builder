...
const AboutHero = () => {
  ...
  return <section ref={containerRef} className="relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          y
            ...
            delay: 0.5
              ...
              <a href="/contact" className="group inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary to-accent text-white font-medium shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 hover:-translate-y-0.5 transition-all duration-300 font-body text-sm text-center rounded">
                Start Your Project
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </a>
              <a href="/solutions" className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 hover:bg-white/15 border border-white/20 text-white font-medium transition-all duration-300 font-body text-sm backdrop-blur-sm rounded">
                Explore Solutions
              </a>
            </motion.div>
            ...
            delay: 0.6
              ...
              label: "Pan-India"
                  ...
                  <motion.div className="absolute -bottom-1 left-0 h-0.5 bg-gradient-to-r from-primary to-accent rounded-full" initial={{
                width: 0
              }} animate={{
                width: 24
              }} transition={{
