  ...
  return (
    <section id="team" className="section-padding-sm bg-off-white" ref={ref}>
      <div className="container-wide">
        ...
        {/* Full-width Leadership Layout */}
        <div className="grid lg:grid-cols-3 gap-6 items-start">
          {/* Founder Featured Block - Takes 2 columns on large screens */}
          <motion.div
          ...
          {/* Other Leaders - Stacked in remaining column */}
          <div className="flex flex-col gap-6 lg:col-span-1">
            {leaders.map((leader, index) => (
              <motion.div
                ...
                className="group bg-white rounded-xl shadow-md border border-border/50 overflow-hidden"
              >
                <div className="flex items-center gap-4 p-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground font-body line-clamp-2">{leader.description}</p>
                  </div>
                </div>
              </motion.div>
            ))}
