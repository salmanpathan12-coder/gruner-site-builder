...
const BiogasSystemVisual = () => {
  return <div className="relative w-full h-full min-h-[400px] md:min-h-[500px]">
      ...
      delay: 0.3
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-primary/30 to-accent/20 border-2 border-accent/60 rounded-t-full rounded-b-lg shadow-2xl shadow-primary/40">
          ...
          repeat: Infinity,
          delay: i * 0.4
        }} className="absolute bottom-1/4 rounded-full bg-gradient-to-t from-accent/70 to-primary/50 shadow-lg" style={{
          left: `${15 + i * 13}%`,
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 400 400">
        ...
        <motion.path d="M200 150 Q 280 150 300 200" fill="none" stroke="url(#energyGradientDark)" strokeWidth="4" strokeDasharray="12 6" initial={{
        pathLength: 0
      }} animate={{
        pathLength: 1
      }} transition={{
        ...
        <motion.path d="M100 320 Q 150 280 200 250" fill="none" stroke="url(#energyGradientDark)" strokeWidth="4" strokeDasharray="12 6" initial={{
        pathLength: 0
      }} animate={{
        pathLength: 1
      }} transition={{
        ...
        <motion.path d="M320 300 Q 340 250 320 100" fill="none" stroke="url(#energyGradientDark)" strokeWidth="4" strokeDasharray="12 6" initial={{
        pathLength: 0
      }} animate={{
        pathLength: 1
      }} transition={{
      ...
      {/* Floating particles */}
      {[...Array(12)].map((_, i) => <motion.div key={i} animate={{
      ...
      repeat: Infinity,
      delay: i * 0.3
    }} className="absolute w-2.5 h-2.5 rounded-full bg-gradient-to-r from-accent to-primary shadow-lg shadow-accent/60 blur-sm" style={{
...
const TechnologyHero = () => {
  return <section className="relative min-h-[60vh] md:min-h-[70vh] flex items-center overflow-hidden pt-28 pb-16 md:pt-36 md:pb-20 bg-white">
      {/* WHITE BACKGROUND */}
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          duration: 0.7
            ...
            delay: 0.8
              ...
              {["Mesophilic", "Thermophilic", "Bio-CNG", "Smart Grid"].map((tag, i) => <motion.span key={tag} initial={{
              opacity: 0,
              scale: 0.9
            }} animate={{
              opacity: 1,
