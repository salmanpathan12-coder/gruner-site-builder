    ...
    <PageLayout>
      ...
      <section className="py-12 md:py-16" style={{ backgroundColor: "#FAF7F2" }}>
        <div className="container-wide">
          ...
          {/* Full-width Quick Response Promise - Below Form & Contact Cards */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            {/* Quick Response Promise Card - Full Width */}
            ...
            <div className="bg-white rounded-xl border border-border shadow-sm p-6 md:p-8">
              ...
              <div className="flex justify-center gap-4">
                <a
                  ...
                  className="w-12 h-12 rounded-xl bg-muted hover:bg-[#1877F2] hover:text-white flex items-center justify-center transition-all duration-300"
                  aria-label="Facebook"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 rounded-xl bg-muted hover:bg-gradient-to-br hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] hover:text-white flex items-center justify-center transition-all duration-300"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 rounded-xl bg-muted hover:bg-[#0A66C2] hover:text-white flex items-center justify-center transition-all duration-300"
                  aria-label="LinkedIn"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 rounded-xl bg-muted hover:bg-black hover:text-white flex items-center justify-center transition-all duration-300"
                  aria-label="Twitter"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section className="bg-white">
        <div className="container-wide py-10">
          ...
          >
            {/* Map iframe - Using place search with company name */}
            <iframe
              src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=Gruner+Renewable+Energy,Windsor+Grand,Sector+126,Noida&zoom=17"
              width="100%"
              height="400"
              style={{ border: 0 }}
              allowFullScreen
