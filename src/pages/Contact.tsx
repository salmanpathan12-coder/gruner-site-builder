        ...
        <div className="container-wide">
          ...
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            >
              ...
              {/* Quick Response Promise Card - Compact, aligned with form */}
              <div className="bg-white rounded-xl border border-border shadow-sm p-5 md:p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-base font-semibold text-black mb-0.5">Quick Response Promise</h4>
              ...
              {/* Connect With Us Card - Same style as Business Hours */}
              <div className="p-6 bg-white rounded-xl border border-border shadow-sm hover:shadow-md hover:border-primary/30 transition-all duration-300">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-primary to-accent flex items-center justify-center flex-shrink-0">
                    <Mail className="w-6 h-6 text-white" />
                  </div>
                  <div className="flex-1">
                    <h3 className="font-semibold text-black mb-3">Connect With Us</h3>
