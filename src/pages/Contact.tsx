    ...
    <PageLayout>
      ...
      <section className="py-12 md:py-16" style={{ backgroundColor: "#FAF7F2" }}>
        <div className="container-wide">
          ...
          {/* Full-width Quick Response + Connect With Us Card - Below Form */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div className="bg-white rounded-xl border border-border shadow-sm overflow-hidden">
              <div className="grid md:grid-cols-2">
                ...
                <div className="p-6 bg-gradient-to-br from-primary/10 to-accent/10 md:border-r border-b md:border-b-0 border-primary/10">
