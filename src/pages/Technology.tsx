      ...
      <section className="py-16 bg-white">
        <div className="container-wide grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <span className={`inline-flex items-center px-6 py-3 rounded-md text-base text-white font-semibold tracking-wide shadow-lg shadow-primary/20 transition-all duration-300 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5 ${GRADIENT}`}>Our Technology</span>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-wide grid lg:grid-cols-2 gap-12 items-start">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <span className={`inline-flex items-center px-6 py-3 rounded-md text-base text-white font-semibold tracking-wide shadow-lg shadow-primary/20 transition-all duration-300 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5 ${GRADIENT}`}>The Process</span>
      ...
      <section className="py-16 bg-white">
        <div className="container-wide space-y-10">
          <div className="space-y-4">
            <span className={`inline-flex items-center px-6 py-3 rounded-md text-base text-white font-semibold tracking-wide shadow-lg shadow-primary/20 transition-all duration-300 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5 ${GRADIENT}`}>Benefits</span>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-wide grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <span className={`inline-flex items-center px-6 py-3 rounded-md text-base text-white font-semibold tracking-wide shadow-lg shadow-primary/20 transition-all duration-300 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5 ${GRADIENT}`}>Sustainability</span>
