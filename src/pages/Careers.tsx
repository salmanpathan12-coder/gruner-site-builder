...
const jobOpenings = [
  {
    ...
    description: "Lead the design and implementation of Bio-CNG plant projects. Oversee engineering teams and ensure project delivery within timelines."
  },
  {
    id: 2,
    ...
    description: "Manage day-to-day operations of Bio-CNG plants. Ensure optimal plant performance and maintenance schedules."
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description: "Identify and develop new business opportunities. Build relationships with potential clients and partners."
  },
  {
    id: 5,
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Our team of 250+ experts comes from diverse backgrounds, united by a shared commitment to innovation 
                and environmental responsibility. We offer a collaborative environment where your contributions matter.
              </p>
              
              <div className="flex items-center gap-8">
                <div>
                  <div className="text-4xl font-heading font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">250+</div>
                  <div className="text-muted-foreground text-sm">Team Members</div>
                </div>
                <div>
                  <div className="text-4xl font-heading font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">63+</div>
                  <div className="text-muted-foreground text-sm">Projects</div>
                </div>
                <div>
                  <div className="text-4xl font-heading font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Pan India</div>
        ...
        <div className="container-wide">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Find the best one available position for you
            </p>
          </motion.div>
